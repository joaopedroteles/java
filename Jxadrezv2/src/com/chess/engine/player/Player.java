...
public abstract class Player {
    ...
    private King establishKing() {
        ...
        throw new RuntimeException(" u shouldnt hit here! not a valid board!!");
    }
    ...
    public MoveTransition makeMove(final Move move) {
        ...
        if(!KingAttacks.isEmpty()) {
            return new MoveTransition(this.board, move, MoveStatus.LEAVES_PLAY_IN_CHECK);
        }
    ...
    protected abstract Collection<Move> calculateKingCastle(Collection<Move> playerLegals,
                                                            Collection<Move>  opponetsLegals);
